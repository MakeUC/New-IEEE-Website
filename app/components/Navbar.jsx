  ...
  return (
    <>
      <div className="top-0 left-0 w-full h-8 bg-[#1c1c1c] justify-end z-[101] flex items-center">
        <ul className="flex space-x-4 md:mr-[2rem] lg:mr-[28rem]">
          <a href="https://x.com/UC_IEEE" target="_blank">
            <li>
              <FaXTwitter
                className="text-white hover:text-[#00B5E2] transform duration-500"
                size={16}
              />
            </li>
          </a>
          ...
          <a href="mailto:execieee@gmail.com" target="_blank">
            <li>
              <MdOutlineEmail
                className="text-white hover:text-[#00B5E2] transform duration-500"
                size={16}
          ...
          <a href="https://github.com/IEEEatUC" target="_blank">
            <li>
              <IoLogoGithub
                className="text-white hover:text-[#00B5E2] transform duration-500"
                size={16}
      ...
      <div
        className={
          shadow
            ? "top-0 fixed w-full h-14 z-[100] bg-[#fbfbfd] backdrop-filter border-b-2 border-b-[#d6d6d6] backdrop-blur-lg bg-opacity-50 transition-shadow duration-500"
